...
public class Judge {
	...
	public Boolean checkUsername(String username) {
		...
		try {
			...
			flag = matcher.matches();
			 ...
			 Object[] paramsObjects={username};
			ResultSet rsResultSet= db.executeSQLWithResult("select * from [user] where user_name=?", paramsObjects);
	...
	// 匹配电话号码
	public Boolean checkMobileNumber(String tel) {
